class StoreManager::StoreController < StoreManager::Base
  ...
  private
    ...
    def store_params
      params.require(:store).permit(:store_name, :adress, :store_phonenumber, :store_description, :payment, :customer_request, :question, store_images_attributes:[:id, {store_image: []},:remove_store_image, {sm_image: []},:remove_sm_image ])
    end
end
